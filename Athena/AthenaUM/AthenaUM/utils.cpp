...
void utils::output::printl()
{
    ...
    printf("      / \\ | |_| |__   ___ _ __   __ _   / ___| |__   ___  __ _| |_ ___ \n");
    printf("     / _ \\| __| '_ \\ / _ \\ '_ \\ / _` | | |   | '_ \\ / _ \\/ _` | __/ __|\n");
    printf("    / ___ \\ |_| | | |  __/ | | | (_| | | |___| | | |  __/ (_| | |_\\__ \\\n");
    printf("   /_/   \\_\\__|_| |_|\\___|_| |_|\\__,_|  \\____|_| |_|\\___|\\__,_|\\__|___/\n");
    printf("                                                                       \n\n");
    return;
