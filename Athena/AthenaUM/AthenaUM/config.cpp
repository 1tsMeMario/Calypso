...
void Config::createConfigFile()
{
    ...
    if (configFile.is_open())
    {
		...
		configFile << "# Steam Path spaces must be replaced with underscores\n";
		configFile << "[Steam]\n";
        configFile << "path: \"C:\\Program_Files_(x86)\\Steam\"\n\n";
        configFile << "[Arduino]\n";
